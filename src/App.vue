<script setup>
import '@/assets/modernize/libs/jquery/dist/jquery.min.js'
          ...
          >
            <div class="d-flex">
              ...
              <div class="unlimited-access-img">
                <img src="@/assets/modernize/images/backgrounds/rocket.png" alt="" class="img-fluid" />
              </div>
            </div>
          </div>
        </nav>
            ...
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                <a href="javascript:void(0)"
                  ><img
                    src="@/assets/modernize/images/products/s4.jpg"
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                <a href="javascript:void(0)"
                  ><img
                    src="@/assets/modernize/images/products/s5.jpg"
                    class="card-img-top rounded-0"
                    alt="..."
                /></a>
                <a
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                <a href="javascript:void(0)"
                  ><img
                    src="@/assets/modernize/images/products/s7.jpg"
                    class="card-img-top rounded-0"
                    alt="..."
                /></a>
                <a
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="card overflow-hidden rounded-2">
              <div class="position-relative">
                <a href="javascript:void(0)"
                  ><img
                    src="@/assets/modernize/images/products/s11.jpg"
                    class="card-img-top rounded-0"
                    alt="..."
                /></a>
                <a
...
<style>
@import '@/assets/modernize/css/styles.min.css';
</style>
